            ...
            <div class="xl:col-span-8 lg:col-span-8 md:col-span-7 sm:col-span-12 xl:pr-[30px] lg:pr-[30px] md:pr-[30px]">
                ...
                >
                  ...
                  <div class="single-blog-content bg-[#070707] p-5">
                    <h4>
                      <Link
                        href={item.postlink}
                        class="post-title group-hover:text-[#ff5100] inline-block text-2xl font-semibold leading-10 capitalize"
                      >
                        {item.title}
                      </Link>
                    </h4>
              ...
              <div class="khalif-pagination my-[50px]">
                <ul class="pagination flex items-center text-center">
                  <li class="w-[60px] h-[60px] leading-[55px] rounded-[100%] border-[1px] border-solid border-[#eeeeee]  text-[#ff5100] mr-4 hover:bg-[#ff5100] hover:text-white transition-all duration-[0.3s] font-semibold font-antonio text-lg cursor-pointer">
                    <Link href="#">1</Link>
                  </li>
                  <li class="w-[60px] h-[60px] leading-[55px] rounded-[100%] border-[1px] border-solid border-[#eeeeee]  text-[#ff5100] mr-4 hover:bg-[#ff5100] hover:text-white transition-all duration-[0.3s] font-semibold font-antonio text-lg cursor-pointer">
                    <Link href="#">2</Link>
