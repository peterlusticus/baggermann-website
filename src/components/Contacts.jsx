...
const ContactData = {
  ...
  ContactinfoList: [
    ...
    },
    {
      ...
      info: '<li class="text-xl text-white font-medium"><Link class="text-xl text-white font-medium" href="mailto:ackermann.paul@gmx.de">ackermann.paul@gmx.de</Li></li><li class="text-xl text-white font-medium"></li>',
      delay: "100",
    },
  ],
};
